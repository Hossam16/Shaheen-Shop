          ...
          <div class="col-md-10" style="margin-left: 250px;">
            ...
            <div class="card card-secondary">
              ...
              <div class="card-body">
                  ...
                  <div class="row">
                  <form method="Post">
                  <button type="submit" class="btn btn-app" name="top100Products" <?php if($_SESSION['type']=='viewer') {echo'disabled';}?>>
                  <span class="badge bg-success">100</span>
                  <i class="fas fa-barcode"></i> أكثر 100 منتج
                </button>
                </form>


                <form method="Post">
                  <button type="submit" class="btn btn-app" name="down100Products" <?php if($_SESSION['type']=='viewer') {echo'disabled';}?>>
                  <span class="badge bg-success">100</span>
                  <i class="fas fa-barcode"></i> أقل 100 منتج
                </button>
                </form>
                  </div>
                ...
                <script>  function fnExcelReport()
{
    ...
    return (sa);
            ...
            <?php if(isset($_POST['top100Products']))
             {
              ?>
