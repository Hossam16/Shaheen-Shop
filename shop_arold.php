...
if(isset($_GET['ID']))
{
    ...
    $conn45 = new config();
    $sql45 = "SELECT pro.* FROM products pro INNER JOIN nsub s on pro.SID=s.ID INNER JOIN ncat h on s.catid=h.ID where pro.Stock!=0 AND s.catid='$sid' AND pro.Price>='$mini' AND pro.Price<='$max'";
...
if(isset($_GET['SID']))
{
    ...
    $conn45 = new config();
    $sql45 = "SELECT * FROM products where products.Stock!=0 AND SID='$sid' AND Price>='$mini' AND Price<='$max'";
    $result45 = $conn45->datacon()->query($sql45);
    $SST=1;
}
if(isset($_GET['HID']))
{
    ...
    $conn45 = new config();
    $sql45 = "SELECT pro.*FROM products pro INNER JOIN nsub s on pro.SID=s.ID INNER JOIN ncat h on s.catid=h.ID INNER JOIN nheader on h.headerid=nheader.ID where pro.Stock!=0 AND nheader.ID='$sid' AND pro.Price>='$mini' AND pro.Price<='$max'";
    $result45 = $conn45->datacon()->query($sql45);
    $SST=1;
}
if(isset($_GET['Free']))
{
    ...
    $hid = 6;
    $conn45 = new config();
    $sql45 = "SELECT * from products WHERE products.Stock!=0 AND size='Free' AND Price>='$mini' AND Price<='$max'";
    $result45 = $conn45->datacon()->query($sql45);
    $SST=1;
}
if(isset($_GET['Offers']))
{
    ...
    $hid = 7;
    $conn45 = new config();
    $sql45 = "SELECT products.*,nsub.id AS SSID,ncat.ID CATID,nheader.id AS HEADID from products INNER JOIN nsub on nsub.ID=products.SID INNER JOIN ncat on ncat.ID=nsub.catid INNER JOIN nheader on nheader.id = ncat.headerid WHERE BSale=1 AND products.SID!=74 AND products.SID!=76 AND products.SID!=78 ORDER BY HEADID,CATID,SSID";
    $result45 = $conn45->datacon()->query($sql45);
    $SST=1;
}
if(isset($_GET['search']))
{
    ...
    $hid = 7;
    $conn45 = new config();
    $sql45 = "SELECT * from products WHERE (products.Stock!=0) AND (products.photo like '%$ncat%' or products.ArName like '%$ncat%' or products.ArDesc like '%$ncat%')";
    $result45 = $conn45->datacon()->query($sql45);
    $SST=1;
}
?>
...
<html>
    ...
    <section id="advertisement">
        <div class="container">
            <img src="images/shop/h<?php echo $hid?>.jpg" alt="" />
        </div>
    </section>
        ...
        .shipping
        {
            display: none;
                        ...
                        <div class="shipping text-center"><!--shipping-->
                            <img src="images/home/55.png" alt="" />
                        </div><!--/shipping-->
        ...
        #phone2
        {
			...
			float: left;
                        ...
                        <div class="col-sm-4" id="phone2">
                            ...
                            ?>
                            <div><img src="images/home/free.png" style="width: 100%;"></div>
                         <?php }else{ ?>
                       <div><img src="images/home/freee.png" style="width: 100%;"></div>
                    <?php } ?>
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        <img src="images/home/<?php echo $row45['Photo']?>" alt="" />
                                    ...
                                    <a href="single_ar.php?ID=<?php echo $row45['ID']?>"><div class="product-overlay">
                                        <div class="overlay-content">

                                            <?php if($row45['BSale']==1){ ?>
                                                <h2> جنية <?php echo $row45['SalePrice'];?></h2>
                                            <?php }else{?>
                                                <h2> جنية <?php echo $row45['Price'];?></h2>
                                            <?php }?>
                                            <p ><?php echo $row45['ArDesc'];?></p>
                                    ...
                                    <?php if($row45['BSale']==1){ ?>
                                        <img src="images/home/salebig.png" class="new" alt="" />
                                    <?php } ?>
                                </div>
								<style>
    ...
    padding-right: 6px;" ><i class="fas fa-heart"></i></button>
                    ...
                    <?php } else{?>
                        <div class="features_items"><h2 class="title text-center">NO Items Found</h2></div>
                    <?php }?>
                    <ul class="pagination">
