...
<section id="cart_items">
    <div class="container">
        <div class="breadcrumbs">
            <ol class="breadcrumb">
                <li>Home</li>
                <li class="active"><a href="#">WishList <i class="fas fa-star"></i></a></li>
            </ol>
        </div>
        <div class="table-responsive cart_info">
            <table class="table table-condensed" style="margin: 0px;">
                ...
                <tr>
                    ...
                    <td style="border: 0; border-left: 1px;border-right: 0px; border-style: inset; text-align: center">
                        <form method="post" >
