...
<section id="form" style="direction: rtl;"><!--form-->
    <div class="container">
        <div class="row" style="text-align: -webkit-center;">
			<img src="images/home/aman.jpg"> 
            <div class="col-sm-4" style="float: none; width: 70%;">
                <div class="signup-form"><!--sign up form-->
                    <h2>طلب تقسيط من أمان</h2>
                    <form role="form" method="post">
						<label>الأسم</label>
                        <input type="text" autocomplete="off" name="name" placeholder="الأسم الرباعي كما وارد في بطاقة الرقم القومي" required/>
						<label>الرقم القومي</label>
                        <input pattern="\d{14}" oninvalid="this.setCustomValidity('Mobile must be 11 number')" oninput="setCustomValidity('')" autocomplete="off" name="IDNum" placeholder="الرقم القومي" required/>
						<label>العنوان</label>
                        <input type="text" autocomplete="off" name="address" placeholder="العنوان كما وارد في بطاقة الرقم القومي" required/>
						<label>عنوان السكن الفعلي</label>
                        <input type="text" autocomplete="off" name="exactaddress" placeholder="العنوان الفعلي" required/>
						...
						<label>الوظيفة</label>
                        <input type="text" autocomplete="off" name="jop" placeholder="الوظيفة مع توضيح جهة العمل" required/>
