                                ...
                                <div class="col-8">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="reservationPro" name="PeriodPro">
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
