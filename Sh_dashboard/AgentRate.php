  ...
  <div class="content-wrapper">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    <form method="Post" style="width: 95%;">
                      ...
                      <button type="submit" name="applyPeriodSaless5" class="btn btn-block btn-default btn-flat" <?php if ($_SESSION['type'] == 'viewer') {
                                                                                                                    echo 'disabled';
                                                                                                                  } ?>>تطبيق</button>
                    </form>
                  </div>
    ...
    ?>
      ...
      <div class="row">
        <div class="card card-success" style="width:100%;">
          <div class="card-header">
            <h3 class="card-title">Agent Data</h3>
          ...
          <div class="card-body">
            <?php $resultDetails = Order::salesOnRangeForAgentDetails($startDate, $endtDate, $_POST['AAID']); ?>
            <table class="table table-striped" id="ssssss">
              <thead>
                <tr>
                  <th>
                    تاريخ الطلب
              ...
              <tbody>
                <?php while ($resultDetail = $resultDetails->fetch_assoc()) { ?>
                  <tr>
                    <td>
                      <?php echo $resultDetail['Date']; ?>
                    </td>
                    <td>
                      <?php echo $resultDetail['ID']; ?>
                    </td>
                    <td>

                    </td>
                    <td>
                      <?php echo $resultDetail['CName']; ?>
                    </td>
                    <td>
                      <table>
                        <tbody>
                          <?php $orderDatas = Orderdata::ViewOrderdata($resultDetail['ID']);
                          $iiii = 0;
                    ...
                    <td>
                      <?php echo $resultDetail['SubTotal']; ?>
                    </td>
                    <td>
                      <?php echo $resultDetail['Status']; ?>
                    </td>
                  </tr>
                <?php } ?>
              </tbody>
            </table>
            <button type="button" class="btn btn-success" onclick="fnExcelReport()">Excel</button>
          </div>
          <!-- /.card-body -->
        </div>
      </div>
      ...
      <script>
        function fnExcelReport() {
          ...
          var textRange;
          var j = 0;
          tab = document.getElementById('ssssss'); // id of table
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div>
            ...
            <button name="create_excel" id="btnExport" onclick="fnExcelReport();" class="btn btn-success" <?php if ($_SESSION['type'] == 'viewer') {
                                                                                                            echo 'disabled';
