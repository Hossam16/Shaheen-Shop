...
if(isset($_POST['submitdate']))
{
    ...
    $name = $_POST['name'];
    $phone = $_POST['phone'];
$res = Order::ViewAllOrdersWebDate($date,$ID,$name,$phone);
}
    ?>
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped" style="text-align: center;display: none;table-layout: fixed;" >
                            ...
                            <tr>
                                ...
                                <td><?php echo($roow['PPrice'] * $roow['Count'])?></td>
                            </tr>
									<?php } ?>
									</table></td>
								...
								<td>
									<form method="post">
                                    <button type="submit" class="btn btn-block btn-danger btn-sm" value="<?php echo($roww['ID']); ?>" name="Cancel" <?php if($_SESSION['type']=='viewer') {echo'disabled';}?>>Cancel</button>
										</form>
                                </td>
                            </tr>
								<?php } ?>
