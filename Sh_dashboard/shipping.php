...
$OID =$OID;
$area =$governorate;
$sql555="SELECT products.Size,SUM(dashorderdata.Count) AS PCount FROM products INNER JOIN dashorderdata on products.ID=dashorderdata.PID WHERE dashorderdata.OID =$OID GROUP BY products.Size";
