...
<?php include"layout.php";?>
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>تاكيد مخزون طلبيات خدمة عملاء</h1>
                </div>
                <div class="col-sm-6">
        ...
        <div class="row">
            ...
            <div class="input-group">
                ...
                <button type="submit" name="select">تحديد</button>
                    ...
                    <div class="card-header">
                        <h3 class="card-title">تاكيد مخزون طلبيات خدمة عملاء</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body" style="direction: rtl;">
                        <table id="example1" class="table table-bordered table-striped" style="text-align: center;" >
                            ...
                            <?php if(isset($_POST['select'])){ ?> 
								<?php  
								$res = Order::ViewAllConfirmedOrdersForStock($_POST['date']);
                  ...
                  <td><?php $rosw['Photo']=explode(".",$rosw['Photo']); echo($rosw['Photo'][0]); ?></td>
                            ...
                            <form  method="post">
                                <select ID="orderDataStatus<?php echo $roow['ID']?>" name="Availability" <?php if($roow['Availability']=='Available'){echo 'disabled';} ?>>
                                    ...
                                    <button type="button" class="btn btn-block btn-info btn-sm" onclick="editODS(<?php echo($roow['ID']); ?>)" value="<?php echo $roow['ID'] ?>" name="Cahnge" <?php if($_SESSION['type']=='viewer') {echo'disabled';}?>>Cahnge</button>
                            </form>
                                </td>
                            </tr>
									<?php } ?>
                    ...
                    <script>
                        function editODS(OrderDataID) {
                          ...
                          jQuery.ajax({
                                          ...
                                          dataType: 'json',
                                          data: {functionname: 'UpdateOrderDataCallStatus', arguments: [NewStatus,NewAlternative,OrderDataID]},
                        ...
                        function editOS(OrderID) {
                            ...
                            jQuery.ajax({
                                          ...
                                          url: 'webJson/orderEdits.php',
                                          dataType: 'json',
                                          data: {functionname: 'UpdateOrderCallStatus', arguments: [NewStatus,OrderID]},
