...
{
  $area = $_POST['area'];
  $rowO = Order::ViewSingleOrdersweb($_POST['OID']);
  ...
  while($row = $rowOD->fetch_assoc())
  {
    ...
    $productss =$productss . '(' . $row['Count']. ')' . $row['ArName'] . '........';
  }
...
$conno=new config();
$OID=$rowO['ID']; 
$sqlll = "INSERT INTO `Aramex`(`OID`, `PNO`) VALUES ($OID,$P_No)";
