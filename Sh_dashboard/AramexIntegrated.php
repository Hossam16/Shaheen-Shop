...
{
  $area = $_POST['area'];
  if(isset($_POST['CSOID']))
  {
    $rowO = Order::ViewSingleOrders($_POST['CSOID']);
    $rowO = $rowO->fetch_assoc();
    $rowOD = Orderdata::ViewOrderdata($rowO['ID']);
    $Service = 'CODS';
    $Currency = 'EGP';
    $Pricee = $rowO['TotalPrice'];
  }elseif(isset($_POST['COID']))
  {
    $rowO = Order::ViewSingleOrdersweb($_POST['COID']);
    $rowO = $rowO->fetch_assoc();
    $rowOD = Orderdata::ViewOrderdataweb($rowO['ID']);
    $Service = 'CODS';
    $Currency = 'EGP';
    $Pricee = $rowO['TotalPrice'];
  }elseif(isset($_POST['CSOIDPayed']))
  {
    $rowO = Order::ViewSingleOrders($_POST['CSOIDPayed']);
    $rowO = $rowO->fetch_assoc();
    $rowOD = Orderdata::ViewOrderdata($rowO['ID']);
    $Service = '';
    $Currency = '';
    $Pricee = 0;
  }elseif(isset($_POST['COIDPayed']))
  {
    $rowO = Order::ViewSingleOrdersweb($_POST['COIDPayed']);
    $rowO = $rowO->fetch_assoc();
    $rowOD = Orderdata::ViewOrderdataweb($rowO['ID']);
    $Service = '';
    $Currency = '';
  ...
  while($row = $rowOD->fetch_assoc())
  {
    ...
    $productss ='ادوات منزلية و كهربائية و مفروشات';
  }
				...
				'Shipment' => array(
						'Shipper'	=> array(
										...
										'Contact'		=> array(
											...
											'FaxNumber'				=> '',
											'CellPhone'				=> '19291',
											'EmailAddress'			=> 'Customer@aramex.com',
											'Type'					=> ''
										),
						),
						...
						'Consignee'	=> array(
										...
										'Contact'		=> array(
											...
											'EmailAddress'			=> 'Info@shaheen.center',
											'Type'					=> ''
										),
						),
...
$conno=new config();
$OID=$rowO['ID'];
if(isset($_POST['CSOID']) OR isset($_POST['CSOIDPayed']))
{
    $sqlll = "INSERT INTO `Aramex`(`OID`, `PNO`) VALUES ('Call$OID',$P_No)";
}
elseif(isset($_POST['COID']) OR isset($_POST['COIDPayed']))
{
    $sqlll = "INSERT INTO `Aramex`(`OID`, `PNO`) VALUES ('Web$OID',$P_No)";
}
	...
	$params = array(
			'Shipments' => array(
				'Shipment' => array(
						...
						'Reference2' 				=> '',
						'Reference3' 				=> '',
						'ForeignHAWB'				=> 'Shaheen-' . $rowO['ID'].'retrun',
						'TransportType'				=> 0,
						'ShippingDateTime' 			=> time(),
						'DueDate'					=> time(),
						'PickupLocation'			=> 'Reception',
...
if(isset($_POST['COID']))
{
    $sqlll = "INSERT INTO `Aramex`(`OID`, `PNO`) VALUES ('ReturnWeb$OID',$P_No)";
}
elseif(isset($_POST['CSOID']))
{
    $sqlll = "INSERT INTO `Aramex`(`OID`, `PNO`) VALUES ('ReturnCall$OID',$P_No)";
}
if ($conno->datacon()->query($sqlll)) {
    } else {
        echo "Error: " . $sqlll . "<br>" . $conno->datacon()->error;
    ...
    <?php } ?>
            ...
            <div class="col-12">
                    <div class="card card-outline card-primary collapsed-card">
                        <div class="card-header">
                                <h3 class="card-title" style="float:right;">طلبات خدمة عملاء</h3>
        ...
        <div class="row">
            <div class="col-12">
                    <div class="card card-outline card-primary collapsed-card">
                        <div class="card-header">
                                <h3 class="card-title" style="float:right;">طلبات خدمة عملاء مسبقة الدفع</h3>
                            ...
                            <div class="card-body" style="display: block;display: none;">
                                <form role="form" method="post">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1" style="float: right;">رقم الطلب</label>
                                        <input type="text" class="form-control" id="exampleInputEmail1" name="CSOIDPayed" placeholder="12345" required>
                                    </div>
                                    <div class="form-group">
                                    <label for="exampleInputEmail1" style="float: right;">المنطقة</label>
                                        <select class="form-control" name="area" required>
        ...
        <div class="row">
            <div class="col-12">
                    <div class="card card-outline card-primary collapsed-card">
                        <div class="card-header">
                                <h3 class="card-title" style="float:right;">طلبات العملاء</h3>
                            ...
                            <div class="card-body" style="display: block;display: none;">
                                <form role="form" method="post">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1" style="float: right;">رقم الطلب</label>
                                        <input type="text" class="form-control" id="exampleInputEmail1" name="COID" placeholder="12345" required>
                                    </div>
                                    <div class="form-group">
                                    <label for="exampleInputEmail1" style="float: right;">المنطقة</label>
                                        <select class="form-control" name="area" required>
        ...
        <div class="row">
            <div class="col-12">
                    <div class="card card-outline card-primary collapsed-card">
                        <div class="card-header">
                                <h3 class="card-title" style="float:right;">طلبات العملاء مسبقة الدفع</h3>
                            ...
                            <div class="card-body" style="display: block;display: none;">
                                <form role="form" method="post">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1" style="float: right;">رقم الطلب</label>
                                        <input type="text" class="form-control" id="exampleInputEmail1" name="COIDPayed" placeholder="12345" required>
                                    </div>
                                    <div class="form-group">
                                    <label for="exampleInputEmail1" style="float: right;">المنطقة</label>
                                        <select class="form-control" name="area" required>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputEmail1" style="float: right;">المبلغ المطلوب تحصيلة</label>
                                        <input type="text" class="form-control" id="exampleInputEmail1" name="OID" placeholder="9999" required>
                                    </div>
                                    <div class="form-group">
                                        <input type="submit" class="btn btn-primary" name="Generate" style="float: right;"  value="تحويل" <?php if($_SESSION['type']=='viewer') {echo'disabled';}?>>
                                    </div>
        ...
        <div class="row">
            <div class="col-12">
                    <div class="card card-outline card-primary collapsed-card">
                        <div class="card-header">
                                <h3 class="card-title" style="float:right;">سحب طلب ويب من عميل</h3>
                                <div class="card-tools" style="float: left;">
                                    <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-plus"></i>
                                    </button>
                                </div>
                            ...
                            <div class="card-body" style="display: block;display: none;">
                                <form role="form" method="post">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1" style="float: right;">رقم الطلب المطلوب سحبة</label>
                                        <input type="text" class="form-control" id="exampleInputEmail1" name="COID" placeholder="12345" required>
                                    </div>
                                    <div class="form-group">
                                    <label for="exampleInputEmail1" style="float: right;">المنطقة</label>
                                    ...
                                    <div class="form-group">
                                        <input type="submit" class="btn btn-primary" name="GenerateToGet" style="float: right;"  value="تحويل" <?php if($_SESSION['type']=='viewer') {echo'disabled';}?>>
                                    </div>
                                </form>
                            </div>
                        <!-- /.card-body -->
        ...
        <div class="row">
            <div class="col-12">
                    <div class="card card-outline card-primary collapsed-card">
                        <div class="card-header">
                                <h3 class="card-title" style="float:right;">سحب طلب خدمة عملاء من عميل</h3>
                                <div class="card-tools" style="float: left;">
                                    <button type="button" class="btn btn-tool" data-card-widget="collapse"><i class="fas fa-plus"></i>
                                    </button>
                                </div>
