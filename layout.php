        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
					...
					<?php if($_SESSION['type']=='developer'){ ?>
                    <li class="nav-item has-treeview <?php echo $product_mo;?>">
                        <a href="#" class="nav-link <?php echo $product_m;?>">
                    ...
                    <li class="nav-item has-treeview <?php echo $orders_m;?>">
                        <a href="#" class="nav-link <?php echo $orders_ma;?>">
                            <i class="nav-icon fas fa-tachometer-alt"></i>
                            <p>
                                مدير الطلبات
                                <i class="right fas fa-angle-left"></i>
					...
					<li class="nav-item has-treeview <?php echo $orders_xm;?>">
                        <a href="#" class="nav-link <?php echo $orders_omm;?>">
                            <i class="nav-icon fas fa-tachometer-alt"></i>
                            <p>
                                Call Center
                                <i class="right fas fa-angle-left"></i>
						...
						<ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="editorder.php" class="nav-link <?php echo $daily_orderssss;?>">
                                    <i class="fas fa-shopping-cart"></i>
                                    <p>Edit Order</p>
                                </a>
                            </li>
