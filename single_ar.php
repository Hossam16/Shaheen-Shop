...
$conn55 =new config();
$conn22 =new config();
$sql55= 'SELECT ID,catar FROM ncat';
                ...
                <div class="left-sidebar">
                    ...
                    <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                        ...
                        while($row55 = $result55->fetch_assoc()) {
                            $CID = $row55['ID'];
                            $sql22= "SELECT subar,ID FROM nsub where catid=$CID AND StatusSub=1";
                                    ...
                                    <div class="panel-body">
                                        <ul>
                                            <?php while($row22 = $result22->fetch_assoc()) {
                                                ?>
                                                <li><a href="shop_ar.php?SID=<?php echo $row22['ID'];?>"> - <?php echo $row22['subar'];?> </a></li>
                                            <?php } ?>
                                        </ul>
                                    </div>
                                </div>
...
<!--                            <h3>ZOOM</h3>-->
                    ...
                    <div class="col-sm-7">
                        <div class="product-information" style="padding-left: 15px;"><!--/product-information-->
                            <img src="images/product-details/0022.png<?php echo  "?" . time(); ?>" style="width: 50px" class="newarrival" alt="" />
                            <h2 style="line-height: 1.9;" ><?php echo $name;?></h2>
                            <p>كود المنتج: <?php echo explode("." , $photo)[0];?></p>
    		...
    		box-shadow: -1px -2px 8px 0 rgba(0,0,0,0.2);
                            ...
                            <form method="post">
                                <span>
									<div>
                                    <?php if($bsale==1){ ?>
                                    <span><?php echo $saleprice;?> جنية</span>
                                    <h3><strike><?php echo $price;?> جنية</strike></h3>
                                    <?php }else{ ?>
									<span><?php echo $price;?> جنية</span>
                                    <?php }?>
									<label>الكمية :</label>
									...
									<div>
									<button type="submit" class="btn btn-fefault cart" name="AddToCart" id="addToCartButton" style="margin-top: 14px; margin-right: 0px">
                            ...
                            <p style="<?php if($sid==79){echo "font-size: 21px;font-weight: bold;";}; ?>">
                            <b>متاح منه :</b> <?php if($stock > 0)
                                {
                                    if($sid==79)
                                    {
                                        echo $stock;
                ...
                <div class="category-tab shop-details-tab"><!--category-tab-->
                    <div class="col-sm-12">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#details" data-toggle="tab">الوصف</a></li>
                            <li><a href="#companyprofile" data-toggle="tab">منتجات مرشحة</a></li>
                            <li><a href="#reviews" data-toggle="tab">التقيمات</a></li>
                        </ul>
                    </div>
                    <div class="tab-content">
                        <div class="tab-pane fade active in" id="details" >
                            <div class="col-sm-12">
                                <h2 style="font-weight: bold;text-decoration:underline;">المواصفات</h2>
                                <br>
                                ...
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <a href="single_ar.php?ID=<?php echo $row99['ID'];?>"><img src="images/home/<?php echo $row99['Photo']?><?php echo  "?" . time(); ?>" alt="" />
                                            <h2><?php echo $row99['Price']?></h2>
                                            <p><?php echo $row99['ArName']?></p>
                                            </a>
                                            <button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>أضف الي العربة</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="reviews" >
                            <div class="col-sm-12">
                                ...
                                <form action="#">
                                    ...
                                    <b>التقيم</b> <img src="images/product-details/rating.png<?php echo  "?" . time(); ?>" alt="" />
